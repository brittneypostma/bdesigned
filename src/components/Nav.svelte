...
<nav>
	<input type="checkbox" id="nav-check" class="hidden" bind:checked={clicked} on:click={openNav} />

	<div class="flex nav-btn item">
		<label for="nav-check">
			<img src="hamburger.svg" alt="nav menu button" class="cursor-pointer lg:hidden" />
		</label>
	</div>
	...
	<ul
		...
		<li><a href="https://console-logs.netlify.app/"> console-logs </a></li>
		<Toggle />
	</ul>
</nav>
